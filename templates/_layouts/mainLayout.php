        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="navbar-brand" href="<?=Dispatcher::dispatcher()->encodeUri("site/home")?>">Home <span
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item"
                            href="<?=Dispatcher::dispatcher()->encodeUri("goods/show", ['page' => 1])?>">Товары</a>
                        <a class="dropdown-item"
                            href="<?=Dispatcher::dispatcher()->encodeUri("recipt/show", ['page' => 1])?>">Покупатели</a>
                            
                        <a class="dropdown-item <?=$_SESSION['user']['cod'] != "adm" ? " disabled" : ""?>"
                            href="<?=Dispatcher::dispatcher()->encodeUri("users/show", ['page' => 1])?>">Поставщики</a>
                    </div>
